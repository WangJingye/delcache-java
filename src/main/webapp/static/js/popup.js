    ...
    showModal: function (options) {
        ...
        var html = '<div id="modal_event_show" class="modal fade">\
                        ...
                        <div class="modal-header">\
                          ...
                          <button class="close" type="button" id="modal_event_show_close"><span aria-hidden="true">&times;</span></button>\
                        </div>\
                        <div class="modal-body">' + opts['content'] + '</div>\
                        <div class="modal-footer"> \
                            <a class="btn btn-secondary" href="#" id="modal_event_show_cannel">取消</a>\
