...
<form style="width: 80%;margin: auto" method="post">
    ...
    <div class="form-group">
        ...
        <input id="app" type="text" class="form-control" name="app" value="">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input id="module" type="text" class="form-control" name="module" value="">
    </div>
    <div class="form-group">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-8">
            <input type="text" id="table" class="form-control" name="table"
                   value=""></div>
        <div class="col-md-4">
            ...
            <tr>
                ...
                <td class="ftype">
                    ...
                    <select class="form-control" name="ftype[<?= $field ?>]">
                        ...
                        <option value="<?= $x ?>"
                        <?= $data['ftype'][$field] == $x ? 'selected' : '' ?>><?= $ftype ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
                <td class="fchoice">
