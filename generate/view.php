...
<head>
    ...
    <link rel="stylesheet" href="html/bootstrap/css/fonts.css">
</head>
<body>
<form style="width: 80%;margin: auto" method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="app" value="<?= isset($data['app']) ? $data['app'] : 'backend' ?>">
    </div>
    <div class="form-group">
        <label for="path">文件生成路径</label>
        <input type="text" class="form-control" name="path" id="path" value="<?= isset($data['path']) ? $data['path'] : 'path' ?>">
    </div>
    <div class="form-group">
...
<script src="html/bootstrap/js/popper.min.js"></script>
<script src="html/bootstrap/js/bootstrap.js"></script>
<script src="html/js/jquery.validate.js"></script>
<script src="html/js/popup.js"></script>
<script>
    $(function () {
        $('.show-table').click(function () {
            var $this = $(this);
            $.post('run.php', {type: 'show-table', table: $('input[name=table]').val()}, function (res) {
                if (res.code == 200) {
